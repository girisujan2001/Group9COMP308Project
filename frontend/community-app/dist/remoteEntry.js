...
const currentImports = {};
      ...
      let moduleMap = {
"./CommunityApp":()=>{
      dynamicLoadingCss([], false, './CommunityApp');
      return __federation_import('./main-d7b57e9d.js').then(module =>Object.keys(module).every(item => exportSet.has(item)) ? () => module.default : () => module)},};
      const seen = {};
