...
const moduleMap = {'react':{get:()=>()=>__federation_import(new URL('__federation_shared_react-57f88920.js', import.meta.url).href),import:true},'react-dom':{get:()=>()=>__federation_import(new URL('__federation_shared_react-dom-2a1d98d5.js', import.meta.url).href),import:true},'react-router-dom':{get:()=>()=>__federation_import(new URL('__federation_shared_react-router-dom-152fa99c.js', import.meta.url).href),import:true},'@apollo/client':{get:()=>()=>__federation_import(new URL('__federation_shared_@apollo/client-b915527f.js', import.meta.url).href),import:true}};
