...
const currentImports = {};
      ...
      let moduleMap = {
"./AuthApp":()=>{
      dynamicLoadingCss([], false, './AuthApp');
      return __federation_import('./main-d29015dd.js').then(module =>Object.keys(module).every(item => exportSet.has(item)) ? () => module.default : () => module)},};
      const seen = {};
